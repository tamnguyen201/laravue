        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                <li class="active">
                    <a><?php echo trans('master::master.names'); ?></a>
                </li>
                <li class="pull-right">
                    <span class="actions">
                    </span>
            ...
            <div class="tab-content">
                <table id="masters-list" class="table table-striped data-table">
                    <thead class="list_head">
                        ...
                        <th><?php echo trans('master::master.label.status'); ?></th>
                    </thead>
                </table>
            </div>
        </div>
<?php /**PATH D:\xampp\htdocs\website\resources\views/vendor/master/admin/master/list/default.blade.php ENDPATH**/ ?>